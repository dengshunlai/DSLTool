...
{
    return [self dsl_blurWithRadius:blurRadius tintColor:[UIColor colorWithWhite:1.0 alpha:0.3] saturationDeltaFactor:1.4 maskImage:nil];
}

- (UIImage *)dsl_extraLightBlurWithRadius:(CGFloat)blurRadius
{
    return [self dsl_blurWithRadius:blurRadius tintColor:[UIColor colorWithWhite:0.97 alpha:0.82] saturationDeltaFactor:1.4 maskImage:nil];
}

- (UIImage *)dsl_darkBlurWithRadius:(CGFloat)blurRadius
{
    return [self dsl_blurWithRadius:blurRadius tintColor:[UIColor colorWithWhite:0.11 alpha:0.73] saturationDeltaFactor:1.4 maskImage:nil];
}

//模糊核心代码
//原作者：https://github.com/codeschool/UIImage-ImageEffects
- (UIImage *)dsl_blurWithRadius:(CGFloat)blurRadius tintColor:(UIColor *)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor maskImage:(UIImage *)maskImage
{
